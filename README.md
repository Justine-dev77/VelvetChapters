...
Les chapitres publics sont chargés depuis `data/chapters.json`. Les chapitres créés depuis l’éditeur ne sont pas publiés automatiquement en ligne.
...
Ils sont identifiés par un badge **« Local uniquement — non publié »** et ne sont visibles que dans le navigateur et sur l’appareil où ils ont été créés.
